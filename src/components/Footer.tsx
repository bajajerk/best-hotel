...
const FOOTER_SUPPORT = [
  { label: "WhatsApp Concierge", href: "https://wa.me/919833534627", external: true },
  { label: "Email Us", href: "mailto:hello@voyagrclub.com", external: true },
...
const C = {
  ...
  // Aligned with --luxe-champagne (was #C9A961). One champagne across the site.
  champagne: "#c8aa76",
  champagneSoft: "rgba(200,170,118,0.08)",
  ...
  return (
    <footer
      ...
      style={{
        ...
        boxShadow: `inset 0 1px 0 rgba(200,170,118,0.18)`,
      }}
    >
        ...
        >
          ...
          <div className="footer-col footer-col-brand">
            ...
            >
              ...
              <SocialIcon href="mailto:hello@voyagrclub.com" external label="Email">
